...
public class MoPubPostProcessor : MonoBehaviour
{
	...
	{
		UnityEngine.Debug.Log("PostProcess Start: MoPub");
		if( target == BuildTarget.iOS )
		{
			...
			proc.Start();
			// --- mopub likes to live dangerously... don't remove this line when updating
			proc.WaitForExit();
		}
		UnityEngine.Debug.Log("PostProcess End: MoPub");
	}
}
